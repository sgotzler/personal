...
This grant proposal seeks to build and disseminate resources for critical game studies pedagogy. Specifically, this project will develop practical instructional design resources, such as web tutorials and instructional videos, that outline UNC’s Critical Game Studies pedagogy for use by other humanities programs and to create the online infrastructure for sharing these resources with educators throughout the nation.
