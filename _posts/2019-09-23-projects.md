...
Book project in in development. This project investigates the overlapping material histories of computation, work, and play to consider how the procedural components of games, (e.g., object orientated programming languages, role-playing character “stat” lines, and diagrammatic game boards), often model logics of social dependency, racialization, and extractivism in playable form. The book argues that by attending to the working models that games provide us, we can help us address urgent contemporary questions about historical struggle, social ontology, and futurity within the landscape of the increasingly gamified 21st century. 
